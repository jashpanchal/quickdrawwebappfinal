...
document.getElementById("sketch_to_be_drawn").innerHTML = "sketch to be drawn is " + element_of_array;
...
function gotResults(error,results){
    if(error){
        ...
        document.getElementById("confidence").innerHTML = "Confidence: " + Math.floor(results[0].confidence);
    }
}